...
<?php echo form_open('users/new_user','role="form" class="form"') ; ?>
    ...
    <div class="form-group">
      ...
      <input type="radio" name="usr_is_active" value="<?php echo set_radio('usr_is_active', '1', True) ; ?>" /> Active
      <input type="radio" name="usr_is_active" value="<?php echo set_radio('usr_is_active') ; ?>" /> Inactive
     </div>      

    <div class="form-group">
      <button type="submit" class="btn btn-success"><?php echo $this->lang->line('common_form_elements_go');?></button>  
	  or <button type="submit" class="btn-btn-success"><?php echo anchor('users',$this->lang->line('common_form_elements_cancel'),'title="Cancel"');?></button>
    </div>
<?php echo form_close() ; ?>
  </div>
</div>
