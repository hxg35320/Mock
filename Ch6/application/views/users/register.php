<div class="container">
  ...
  <?php echo form_open('register/index', 'role="form" class="form-signin"') ; ?>        
	...
	<!--<input type="text" class="form-control" name="password" placeholder=" <?php echo $this->lang->line('register_password'); ?>" />
    <input type="text" class= "form-control" name="passconf" placeholder= " <?php echo $this->lang->line('register_passconf'); ?>"/>-->
