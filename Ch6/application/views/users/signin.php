...
<?php endif ; ?>
  ...
  <?php echo form_open('signin/index', 'class="form-signin" role="form"') ; ?>
    ...
    <button class="btn btn-lg btn-primary btn-block" type="submit"><?php echo $this->lang->line('admin_login_signin') ; ?></button>
	 ...
	 <br> <a href="http://localhost/ch6/index.php/register" class="btn btn-info" role="button">Register Now</a></br>
	 
	 <!--<button class="btn btn-lg btn-primary btn-block" type="submit" href="http://localhost/ch6/index.php/register" >Register Now</button>-->
    <br />
