  ...
  <button class="btn btn-primary dropdown-toggle" type="button" data-toggle="dropdown">Dash Board
  <span class="caret"></span></button>
  <ul class="dropdown-menu">
    <li><a href="http://localhost/ch6/index.php/me/edit_val">Edit Profile</a></li>
    <li><a href="http://localhost/ch6/index.php/me/me_ud">User Details</a></li>
    <li><a href="http://localhost/ch6/index.php/register">Create New User</a></li>
  </ul>
</div>
