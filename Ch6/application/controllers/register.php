...
class Register extends CI_Controller {
  ...
  public function index() {
    ...
    //$this->form_validation->set_rules('passconf', $this->lang->line('Password Confirmation'), 'required|matches[password]');
    ...
    if ($this->form_validation->run() == FALSE) { // First load, or problem with form
      ...
      if ($this->Register_model->register_user($data)) {
        $file = readfile('C:\wamp64\www\Ch6\application\views\email_scripts\welcome.txt');
